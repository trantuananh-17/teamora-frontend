...
export const flightsKeys = {
  ...
  list: (eventId: string, filters: FlightFilters, pagination: PageParams) => [...flightsKeys.event(eventId), "list", filters, pagination] as const,
  assignments: (eventId: string, pagination: PageParams) => [...flightsKeys.event(eventId), "assignments", pagination] as const,
...
export const allocationRunsOptions = (eventId: string) => queryOptions({
