    ...
    <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        ...
        <FieldGroup className="grid gap-4 sm:grid-cols-2">
          ...
          <Field>
            ...
            <Select
              ...
              onValueChange={(value) => set("direction", value as FlightDirection)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <Field>
            ...
            <Select
              ...
              onValueChange={(value) =>
                set("shift", value === "none" ? null : (value as FlightShift))
              }
            >
              <SelectTrigger>
                <SelectValue />
          ...
          <Field className="sm:col-span-2">
            ...
            <Textarea
              ...
              placeholder="Thông tin hỗ trợ BTC…"
            />
          </Field>
        </FieldGroup>
      </form>
      <DialogFooter>
        ...
        <Button type="submit" form="flight-form" disabled={pending}>
          {pending ? "Đang lưu…" : "Lưu chuyến bay"}
        </Button>
      </DialogFooter>
    </DialogContent>
  )
